  ...
  templateEmail: token => {
   return `<mjml>
    ...
    <mj-body>
      ...
      <mj-section background-color="#000000" padding-top="10">
        <mj-column>
          ...
          <a href="http://localhost:3000/confirm/${token}"></a>
        </mj-column>
      </mj-section>
      <mj-raw>
        <!-- R2-D2 Section -->
      </mj-raw>
      <mj-section background-color="#000000" background-url="https://dmmedia.sphero.com/email-marketing/Star-Wars/Star_Wars_Launch_Email_1.r2BG.jpg" background-repeat="no-repeat" padding-top="80" padding-bottom="0px" padding-left="20px">
        <mj-column>
      ...
      <mj-section background-color="#000000" background-url="https://dmmedia.sphero.com/email-marketing/Star-Wars/Star_Wars_Launch_Email_1REDbg.jpg" background-repeat="no-repeat" padding-top="30" padding-left="20px">
        <mj-column>
