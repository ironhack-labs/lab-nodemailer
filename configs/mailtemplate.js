module.exports.generateTemplate = (email, token) =>{
    ...
    <style type="text/css">
      ...
      <div style="font-family:Arial, sans-serif;font-size:25px;font-weight:bold;line-height:35px;text-align:center;color:#489BDA;">Click on the following button to activate your account<br></div>
      ...
      <div style="font-family:Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#000000;">The Nodemailer-Test
          <p></p></div>
