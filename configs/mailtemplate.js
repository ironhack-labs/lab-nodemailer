module.exports.generateTemplate = (code) => {
    return `
    <!doctype html>
...
.mj-column-per-25 { width:25% !important; max-width: 25%; }
    ...
    @media only screen and (max-width:480px) {
      ...
      ><span style="font-size: 11px">Ironhack Lab-Nodemailer</span></div>
      ...
      >
        ...
        <a
           href="https://slashmobility.com/wp-content/uploads/2016/11/IronHack.png" target="_blank"
        >
          
      <img
         alt="Ironhack-logo" height="auto" src="https://slashmobility.com/wp-content/uploads/2016/11/IronHack.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="182"
      />
      ...
      ><p><span style="color: rgb(106, 138, 162);"><span style="font-weight: bold;"><span style="font-size: 16px;">Ironhack confirmation email</span></span>
            </span>
          </p></div>
      ...
      ><p><span style="color: rgb(57, 63, 76);">Thanks to join our community! Please confirm your account clicking on the following button:</span></div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"
      ><p>Great to see you creating awesome webpages you with us!</p></div>
      ...
      <div  style="background:#8bafad;background-color:#8bafad;margin:0px auto;max-width:600px;">
        
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#8bafad;background-color:#8bafad;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"
      ><p><a href="https://mjml.io" style="text-decoration: none; color: inherit;"><span style="color: rgb(255, 255, 255);">You are doing awesome!</span></a></p></div>
