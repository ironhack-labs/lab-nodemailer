module.exports = {
  template: (username, port, confirmCode) => { return `
  <!doctype html>
  ...
  @media only screen and (max-width:480px) {
    ...
    <img
       alt="" height="auto" src="https://blog.nodemailer.com/wp-content/uploads/2017/01/cropped-nm_logo_1000x680.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
    />
    ...
    >Welcome to Nodemailer Enterprise</div>
    ...
    <div
       class="mj-column-per-100 outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;"
    >
    ...
    ><span style="color:#FEEB35">Dear ${username}</span><br /><br /> Welcome to the best mail ever.</div>
    ...
    >We&apos;re really excited you&apos;ve decided to give us a try. In case you have any questions, feel free to reach out to us at this mail contact. You can login to your account with your username but first, you have to verify your account by clicking on this button:</div>
    ...
    >
      <tr>
        ...
        >
          ...
          >
            <a
            href="http://localhost:${port}/auth/confirm/${confirmCode}"
            style="text-decoration:none;color:#1AA0E1;">Verify</a>
          </p>
        </td>
      </tr>
    </table>
    ...
    <div
       style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:left;color:#ffffff;"
    >Thanks, <br /> Nodemailer Enterprise Team</div>
