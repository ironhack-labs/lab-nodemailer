...
.mj-column-per-45 { width:45% !important; max-width: 45%; }
  ...
  @media only screen and (max-width:480px) {
    ...
    <img
       height="auto" src="https://s3.amazonaws.com/bloc-global-assets/almanac-assets/bootcamps/logos/000/002/680/original/IronHack.png?1467187336" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="200"
    />
    ...
    <div  style="Margin:0px auto;max-width:600px;">
      ...
      >
        <tbody>
          <tr>
            <td
               style="direction:ltr;font-size:0px;padding:0px;padding-top:30px;text-align:center;vertical-align:top;"
            >
              <!--[if mso | IE]>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
    ...
    >
      <h5>Hello ${username}!</h5>
        <p> Thanks to join our community! Please confirm by clicking on the following link: </p>
        <p> ${message} </p>
        <h5 align="center">Great to see you're creating awesome webpages with us!</h5>
    </div>
